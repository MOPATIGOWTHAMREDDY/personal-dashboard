...
const PersonalDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 pb-safe-bottom">
      <div className="container mx-auto px-3 py-4">
        {/* Header */}
        <div className="mb-6 pt-safe-top">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Personal Dashboard</h1>
          <p className="text-gray-600 text-sm">Manage your reminders and budget in one place</p>
        </div>
